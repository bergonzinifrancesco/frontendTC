<script lang='ts'>
    ...
    import {AppShell, AppBar, Avatar, AppRail, AppRailAnchor, LightSwitch} from '@skeletonlabs/skeleton';
            ...
            {#if sidebarIsOpen}
                ...
                >
                    ...
                    {#if isSuperUser}
                        ...
                        <AppRailAnchor href="/modifica-tema" selected={$page.url.pathname === '/modifica-tema'}>Modifica tema del sito</AppRailAnchor>
                    {/if}
                </AppRail>
            {/if}
        </svelte:fragment>
